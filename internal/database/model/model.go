// Package model defines the database models and data structures used by the z-ui panel.
package model
...
// User represents a user account in the z-ui panel.
type User struct {
...
// Setting stores key-value configuration settings for the z-ui panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
...
// Node represents a remote z-ui panel registered with the central panel.

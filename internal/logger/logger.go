// Package logger provides logging functionality for the z-ui panel with
...
var (
	...
	logger     = logging.MustGetLogger("z-ui")
...
func InitLogger(level logging.Level) {
	newLogger := logging.MustGetLogger("z-ui")
	...
	if consoleBackend := initDefaultBackend(); consoleBackend != nil {
		...
		leveledBackend.SetLevel(level, "z-ui")
	...
	if fileBackend := initFileBackend(); fileBackend != nil {
		...
		leveledBackend.SetLevel(logging.DEBUG, "z-ui")
		backends = append(backends, leveledBackend)
	}

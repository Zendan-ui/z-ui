// Package web provides the main web server implementation for the z-ui panel,
...
import (
	...
	"github.com/Zendan-ui/z-ui/v3/internal/config"
	"github.com/Zendan-ui/z-ui/v3/internal/eventbus"
	"github.com/Zendan-ui/z-ui/v3/internal/logger"
	"github.com/Zendan-ui/z-ui/v3/internal/mtproto"
	"github.com/Zendan-ui/z-ui/v3/internal/util/common"
	"github.com/Zendan-ui/z-ui/v3/internal/util/sys"
	"github.com/Zendan-ui/z-ui/v3/internal/web/controller"
	"github.com/Zendan-ui/z-ui/v3/internal/web/job"
	"github.com/Zendan-ui/z-ui/v3/internal/web/locale"
	"github.com/Zendan-ui/z-ui/v3/internal/web/middleware"
	"github.com/Zendan-ui/z-ui/v3/internal/web/network"
	"github.com/Zendan-ui/z-ui/v3/internal/web/runtime"
	"github.com/Zendan-ui/z-ui/v3/internal/web/service"
	"github.com/Zendan-ui/z-ui/v3/internal/web/service/email"
	"github.com/Zendan-ui/z-ui/v3/internal/web/service/panel"
	"github.com/Zendan-ui/z-ui/v3/internal/web/service/tgbot"
	"github.com/Zendan-ui/z-ui/v3/internal/web/websocket"
	"github.com/Zendan-ui/z-ui/v3/internal/xray"
...
// Server represents the main web server for the z-ui panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("z-ui", store))
...
func (s *Server) start(restartXray bool, startTgBot bool) (err error) {
	...
	if envPort, configured, envErr := config.GetPortOverride(); configured {
		if envErr != nil {
			logger.Warning("Ignoring invalid ZUI_PORT; using configured web port:", port, envErr)
		} else {
			port = envPort
			logger.Info("Using ZUI_PORT override for web panel port:", port)
		}
	}
	...
	controller.SetTestTgFunc(func() error {
		...
		s.tgbotService.SendMsgToTgbotAdmins("✅ Test message from z-ui")
		return nil
	})

...
import (
	...
	"github.com/Zendan-ui/z-ui/v3/internal/util/netproxy"
)
...
// ConfigFromEnv builds Config from ZUI_TUNNEL_HEALTH_* environment variables.
//
// Supported variables:
//   - ZUI_TUNNEL_HEALTH_MONITOR=true
//   - ZUI_TUNNEL_HEALTH_URL=https://www.cloudflare.com/cdn-cgi/trace
//   - ZUI_TUNNEL_HEALTH_PROXY=socks5://127.0.0.1:1080
//   - ZUI_TUNNEL_HEALTH_INTERVAL=30s
//   - ZUI_TUNNEL_HEALTH_TIMEOUT=10s
//   - ZUI_TUNNEL_HEALTH_FAILURES=3
//   - ZUI_TUNNEL_HEALTH_COOLDOWN=5m
func ConfigFromEnv() Config {
	cfg := DefaultConfig()

	cfg.Enabled = parseBool(os.Getenv("ZUI_TUNNEL_HEALTH_MONITOR"))
	cfg.URL = firstNonEmpty(os.Getenv("ZUI_TUNNEL_HEALTH_URL"), cfg.URL)
	cfg.ProxyURL = strings.TrimSpace(os.Getenv("ZUI_TUNNEL_HEALTH_PROXY"))
	cfg.Interval = parseDurationEnv("ZUI_TUNNEL_HEALTH_INTERVAL", cfg.Interval)
	cfg.Timeout = parseDurationEnv("ZUI_TUNNEL_HEALTH_TIMEOUT", cfg.Timeout)
	cfg.Cooldown = parseDurationEnv("ZUI_TUNNEL_HEALTH_COOLDOWN", cfg.Cooldown)
	cfg.FailureThreshold = parseIntEnv("ZUI_TUNNEL_HEALTH_FAILURES", cfg.FailureThreshold)

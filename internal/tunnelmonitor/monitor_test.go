...
func TestConfigFromEnvParsesValues(t *testing.T) {
	t.Setenv("ZUI_TUNNEL_HEALTH_MONITOR", "true")
	t.Setenv("ZUI_TUNNEL_HEALTH_URL", "https://example.com/health")
	t.Setenv("ZUI_TUNNEL_HEALTH_PROXY", "socks5://127.0.0.1:1080")
	t.Setenv("ZUI_TUNNEL_HEALTH_INTERVAL", "15s")
	t.Setenv("ZUI_TUNNEL_HEALTH_TIMEOUT", "3s")
	t.Setenv("ZUI_TUNNEL_HEALTH_FAILURES", "4")
	t.Setenv("ZUI_TUNNEL_HEALTH_COOLDOWN", "2m")

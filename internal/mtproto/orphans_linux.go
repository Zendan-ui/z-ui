...
// previous z-ui run and returns how many were killed.
//
// z-ui starts one mtg process per mtproto inbound outside its own lifecycle, and
...
// domain-fronted to the FakeTLS domain instead of proxied to Telegram. z-ui is

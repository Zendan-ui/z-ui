# Contributing to Z-UI Frontend

Thank you for your interest in contributing to Z-UI Frontend. This document explains how to set up the project, follow our conventions, and submit changes.
...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/z-ui.git
   cd z-ui
   ```
3. Add the upstream remote (optional, for syncing):
   ```bash
   git remote add upstream https://github.com/ORIGINAL_OWNER/z-ui.git
   ```
